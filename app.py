...
st.set_page_config(page_title=" Your Age Calculator", layout="wide")

# Define the app header and subheader
st.title("Age Calculator App")
st.subheader("Enter your Date of Birth  to calculate your age")

# Define the input fields for the user's birthdate
year = st.number_input("Year of Birth", min_value=1900,
